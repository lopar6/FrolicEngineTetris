...
class CoreGame(charpy.GameObject): 
    ...
    def spin_shape(self):
        ...
        spos.x < gpos.x + 1 or \
        spos.x > gpos.x + gsize.x - ssize.x - 1 or \
        spos.y > gpos.y + gsize.y - ssize.y - 1 :
    ...
    def draw(self, screen: Screen):
        ...
        if self.laid_shapes:
            self.laid_shapes.draw_laid_shapes(self.grid, screen)
        if self.shape:
    ...
    def draw_info(self, screen: Screen):
